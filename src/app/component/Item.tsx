    ...
    return (
        <li className="flex justify-between items-center bg-gray-900 rounded-xl px-5 py-3 w-full max-w-[700px] hover:shadow-xl">
            <div className="left flex">
                {/* Menu Icon */}
                <svg width="24px" height="24px" className="mr-5"viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
            ...
            <div className="flex gap-2">
                ...
                {/* Edit Icon */}
                <svg width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" strokeWidth="0">
                    <g id="SVGRepo_iconCarrier"> 
                ...
                {/* Delete Icon */}
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" onClick={() => deleteTask(_id)}>
                    <g id="SVGRepo_iconCarrier"> 
