...
export default function Item({ _id, title, description, marked, dueDate, deleteTask }) {
    ...
    return (
        <li className="bg-gray-900 rounded-xl px-5 py-3 w-full max-w-[700px] hover:shadow-xl">
            <div className="task-title flex justify-between items-center ">
                <div className="left flex items-center grow">
                    ...
                    {isEditing ? (
                        <input 
                            type="text" 
                            className="bg-transparent inline-block text-red-300 text-xl w-full focus:outline-none" 
                            ref={inputRef} 
                            value={titleInput} 
                ...
                <div className="right flex gap-2">
                    {/* Down Icon */}
                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => setIsDescriptionOpen((curr) => !curr)} className="cursor-pointer">
                        <g id="SVGRepo_iconCarrier"> 
                            <path d="M7 10L12 15L17 10" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> 
                        </g>
                    </svg>
                    {/* Edit Icon */}
                    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" onClick={() => setIsEditing(true)} className=" cursor-pointer">
                        <g id="SVGRepo_iconCarrier"> 
